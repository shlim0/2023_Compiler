...
char *type_kind_name[] = {"NULL",  "ENUM", "ARRAY",   "STRUCT",
                          "UNION", "FUNC", "POINTER", "VOID"};
...
char *id_kind_name[] = {"NULL", "VAR",  "FUNC",   "PARM",        "FIELD",
                        "TYPE", "ENUM", "STRUCT", "ENUM_LITERAL"};
